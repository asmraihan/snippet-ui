...
Snippet UI currently only support **React**. This project and all components are written in **TypeScript**. We recommend using TypeScript for your project as well.
